...
-- AddForeignKey
ALTER TABLE "vinculacion_jefes" ADD CONSTRAINT "vinculacion_jefes_empleadoId_fkey" FOREIGN KEY ("empleadoId") REFERENCES "worker_details"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vinculacion_jefe_areas" ADD CONSTRAINT "vinculacion_jefe_areas_areaId_fkey" FOREIGN KEY ("areaId") REFERENCES "areas"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vinculacion_jefe_departamentos" ADD CONSTRAINT "vinculacion_jefe_departamentos_departamentoId_fkey" FOREIGN KEY ("departamentoId") REFERENCES "departamentos"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vinculacion_jefe_puestos" ADD CONSTRAINT "vinculacion_jefe_puestos_puestoId_fkey" FOREIGN KEY ("puestoId") REFERENCES "puestos"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "vinculacion_jefe_empleados" ADD CONSTRAINT "vinculacion_jefe_empleados_empleadoId_fkey" FOREIGN KEY ("empleadoId") REFERENCES "worker_details"("id") ON DELETE CASCADE ON UPDATE CASCADE;
