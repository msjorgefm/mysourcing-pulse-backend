...
exports.CompanyWizardService = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class CompanyWizardService {
    // Inicializar wizard para una nueva empresa
    static async initializeWizard(companyId) {
        try {
    ...
    static async getWizardStatus(companyId) {
        try {
    ...
    static async updateWizardStep(companyId, sectionNumber, stepNumber, stepData) {
        try {
    ...
    static async processStepData(companyId, sectionNumber, stepNumber, stepData) {
        try {
    ...
    static async processBankData(companyId, stepData) {
    ...
    static async processDigitalCertificateData(companyId, stepData) {
    ...
    static async processOrganizationalData(companyId, stepNumber, stepData) {
    ...
    static async processBenefitsData(companyId, stepNumber, stepData) {
    ...
    static async processPayrollData(companyId, stepData) {
    ...
    static async processHRData(companyId, stepNumber, stepData) {
    ...
    // Completar wizard
    static async completeWizard(companyId) {
        try {
...
exports.CompanyWizardService = CompanyWizardService;
//# sourceMappingURL=companyWizardService.js.map